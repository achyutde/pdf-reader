...
import { renderPage, clearHL, drawHL, showTicker, savePosition } from './pdf.js?v=2.2.4';
import { hardStop, startFrom, updateBtn } from './speech.js?v=2.2.4';
import { toast } from './ui.js?v=2.2.4';
