...
import { renderPage, clearHL, drawHL, showTicker, savePosition } from './pdf.js?v=2.0.1';
import { hardStop, startFrom, updateBtn } from './speech.js?v=2.0.1';
import { toast } from './ui.js?v=2.0.1';
